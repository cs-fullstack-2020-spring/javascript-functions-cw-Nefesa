...
//     ${oddnam2}`);
//     // !! no need for this code block?
//     {
//         return (oddnam1 + oddnam2);
//         // !! : retruning a function sets the value and no other actions can be preformed after a return
...
// {
//     // !! your function should take some number
//     for  (i=0; i=50; i++)
//     {
//         console.log(i);
//     }
